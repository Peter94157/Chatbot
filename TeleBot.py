...
/Lock
/Smartwatche
If you are interested in the subject this link will guide you->
    """)
...
def option4 (mensagem):
    img = open('Desenvolvedores.jpg','rb')
    bot.send_photo(mensagem.chat.id,img)
    bot.reply_to(mensagem,"""My creators the students:
Antonio - https://www.linkedin.com/in/figueiredoantonio/
João - https://www.linkedin.com/in/joao-victor-2041771a6/
Pedro - https://www.linkedin.com/in/pedro-l-57bb93168/
Yan - https://www.linkedin.com/in/yan-marques-de-lima-29b520236/
""")

@bot.message_handler(commands=["Echo"])
def responder(mensagem):
    nome=mensagem.chat.first_name 
    img = open('alexa.jpeg','rb')
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome},If interested in buying, link below
https://amzn.to/43yoJjE""")
...
@bot.message_handler(commands=["VacuumCleaner"])
def responder(mensagem):
    nome=mensagem.chat.first_name 
    img = open('Aspirador.jpeg','rb')
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome},If interested in buying, link below
https://bit.ly/45Zceis""")
    bot.send_message(mensagem.chat.id,
f"""/Echo
/Glasses
/Lock
...
@bot.message_handler(commands=["Glasses"])
def responder(mensagem):
    nome=mensagem.chat.first_name 
    img = open('Holo_oculos.jpg','rb')
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome},If interested in buying, link below
https://amzn.to/3qGb6A5""")
    bot.send_message(mensagem.chat.id,
f"""/Echo
/VacuumCleaner
/Lock
...
def responder(mensagem):
    nome=mensagem.chat.first_name 
    img = open('Fechadura.jpeg','rb')
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome},If interested in buying, link below
https://amzn.to/3oVrdtc""")
    bot.send_message(mensagem.chat.id,
f"""/Echo
/VacuumCleaner
/Glasses
...
@bot.message_handler(commands=["Smartwatche"])
def responder(mensagem):
    nome=mensagem.chat.first_name 
    img = open('Smartwatche.jpeg','rb')
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome},If interested in buying, link below
https://amzn.to/3X441FJ""")
    bot.send_message(mensagem.chat.id,
f"""/Echo
/VacuumCleaner
/Glasses
...
Caso se interrese pelo assunto esse link irá guia-lo -> https://www.techtudo.com.br/noticias/2022/10/o-que-e-internet-das-coisas-veja-como-funciona-a-iot-e-exemplos-de-uso.ghtml
""")
...
def responder(mensagem):
    ...
    img = open('alexa.jpeg','rb')
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome}, Caso se interesse em comprar, link abaixo
https://amzn.to/3qB0iTY""")
    bot.send_message(mensagem.chat.id,
f"""/Aspirador
/Oculos
/Fechadura
...
@bot.message_handler(commands=["Aspirador"])
def responder(mensagem):  
    img = open('Aspirador.jpeg','rb')
    nome=mensagem.chat.first_name
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome}, Caso se interesse em comprar, link abaixo
https://bit.ly/3Nmqz18""")
    bot.send_message(mensagem.chat.id,
f"""/Alexa
/Oculos
/Fechadura
...
@bot.message_handler(commands=["Fechadura"])
def responder(mensagem):  
    img = open('Fechadura.jpeg','rb')
    nome=mensagem.chat.first_name
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome}, Caso se interesse em comprar, link abaixo
https://bit.ly/43zgUtT""")
    bot.send_message(mensagem.chat.id,
f"""/Alexa
/Aspirador
/Oculos
...
@bot.message_handler(commands=["Oculos"])
def responder(mensagem):
    nome=mensagem.chat.first_name  
    img = open('Holo_oculos.jpg','rb')
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome}, Caso se interesse em comprar, link abaixo
https://bit.ly/3qsUifW""")
    bot.send_message(mensagem.chat.id,
f"""/Alexa
/Aspirador
/Fechadura
...
@bot.message_handler(commands=["Relogio_inteligente","Smartwatche"])
def responder(mensagem):  
    img = open('Smartwatche.jpeg','rb')
    nome=mensagem.chat.first_name
    bot.send_photo(mensagem.chat.id,img)
    bot.send_message(mensagem.chat.id,f"""{nome}, Caso se interesse em comprar, link abaixo
https://amzn.to/3J8F1Yi""")
    bot.send_message(mensagem.chat.id,
f"""/Alexa
/Aspirador
/Oculos
...
/Quem são seus criadores ? 
---------------------------------- ou / or ---------------------------------------
{nome} i am sorry, i did not understand, Choose one option below !
/Option_1 - What is the internet of things?
/Option_2 - Advantages of using Internet of Things (IoT) devices
/Option_3 - Disadvantages of using Internet of Things (IoT) devices
/Option_4 - Practical examples of IoT
